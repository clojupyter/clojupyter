(ns clojupyter.install.conda.specs
  (:require
   [clojure.spec.alpha				:as s]
   [io.simplect.compose						:refer [def- γ Γ π Π]]
   ,,
   [clojupyter.install.local-specs		:as lsp]  ;; dependency due to :local/file 
   ))
...
(s/def :conda-build-env/kernel-dir		(s/and string? (complement (π re-find #"/")))) 
