...
;;        docstring (str "\n" docstring "\n"
;;                       "IPYWIDGET MODEL-Mwidget-nameODULE-VERSION:\t" model-module-version "\n"
  ...
  (reduce merge
    (for [{n "name" v "default"} attrs]
      (if (or (= n "layout") (= n "style"))
        ...
        ;; Currently, a widget with null reference to layout and style look and act the same way as a widget with refence to default layout and style widgets.
        {(keyword n) nil}
